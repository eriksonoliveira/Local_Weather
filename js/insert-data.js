...
function insertData(latitude, longitude, locationName) {
  ...
  $.getJSON(
    "https://api.openweathermap.org/data/2.5/weather?lat=" +
      ...
      "&lon=" +
      longitude +
      "&APPID=9ad8257fe3d7737f364b3b1ea8e7cc53",
    function(currWeather) {
      /***Set the weather variables from the received JSON data***/
      var tCelsius =
        "<span>" + calcTempC(currWeather.main.temp_max) + "</span>";
      var tFahrenheit =
        "<span>" + Math.round(calcTempF(currWeather.main.temp_max)) + "</span>";
      ...
      $.get(
        "https://api.openweathermap.org/data/2.5/forecast/daily?lat=" +
          ...
          "&lon=" +
          longitude +
          "&cnt=3&APPID=9ad8257fe3d7737f364b3b1ea8e7cc53",
        function(forecWeather) {
          ...
          $.each($(".condF"), function(index, value) {
            ...
            if (
              forecDescr == "heavy intensity rain" ||
              forecDescr == "very heavy rain"
            ) {
